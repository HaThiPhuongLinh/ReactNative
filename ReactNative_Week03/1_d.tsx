          ...
          <TouchableOpacity>
            <svg width="38" height="36" viewBox="0 0 38 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_12_61)">
                <path d="M19.0001 13.091C16.1414 13.091 13.8182 15.2919 13.8182 18.0001C13.8182 20.7083 16.1414 22.9091 19.0001 22.9091C21.8587 22.9091 24.1819 20.7083 24.1819 18.0001C24.1819 15.2919 21.8586 13.091 19.0001 13.091Z" fill="black" />
                <path d="M19 5.72733C10.3636 5.72733 2.98821 10.8164 0 18.0001C2.98821 25.1837 10.3636 30.2728 19 30.2728C27.645 30.2728 35.0119 25.1837 38.0001 18.0001C35.0119 10.8164 27.645 5.72733 19 5.72733ZM19 26.1818C14.2328 26.1818 10.3636 22.5164 10.3636 18C10.3636 13.4836 14.2328 9.81821 19 9.81821C23.7673 9.81821 27.6364 13.4837 27.6364 18.0001C27.6364 22.5164 23.7673 26.1818 19 26.1818Z" fill="black" />
              </g>
              <defs>
  ...
  <View style={{
    ...
    <TouchableOpacity style={{
      ...
      <svg width="23" height="27" viewBox="0 0 23 27" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.5957 21.3115H22.5107V27H0.586914V22.7031L13.0137 6.29688H0.953125V0.583984H22.1201V4.75879L9.5957 21.3115Z" fill="white"/>
      </svg>
    </TouchableOpacity>
    <TouchableOpacity style={{
